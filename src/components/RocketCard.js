  ...
  return (
    <div className='w-full md:w-1/2 lg:w-1/3 xl:w-1/4 p-3'>
      <Link to={`/rockets/${rocket_id}`}>
        <div className='rounded-md bg-white dark:bg-gray-150 h-auto md:h-auto shadow-md overflow-hidden cursor-pointer'>
          <img
          ...
          <div className='w-full p-3'>
            <h1 className='text-xl tracking-wide mb-3'>{rocket_name}</h1>
